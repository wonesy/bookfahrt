...
func (m *ClubMutation) AddMemberIDs(ids ...int) {
	if m.members == nil {
...
func (m *ClubMutation) RemovedMembersIDs() (ids []int) {
...
func (m *ClubMutation) MembersIDs() (ids []int) {
...
func (m *ClubMutation) ResetMembers() {
	m.members = nil
