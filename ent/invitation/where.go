...
// HasSponsor applies the HasEdge predicate on the "sponsor" edge.
func HasSponsor() predicate.Invitation {
	return predicate.Invitation(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(SponsorTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, SponsorTable, SponsorColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasSponsorWith applies the HasEdge predicate on the "sponsor" edge with a given conditions (other predicates).
func HasSponsorWith(preds ...predicate.User) predicate.Invitation {
	return predicate.Invitation(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasClub() predicate.Invitation {
	return predicate.Invitation(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ClubTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, ClubTable, ClubColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasClubWith(preds ...predicate.Club) predicate.Invitation {
	return predicate.Invitation(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
