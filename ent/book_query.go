...
func (bq *BookQuery) QueryGenres() *GenreQuery {
	query := &GenreQuery{config: bq.config}
...
func (bq *BookQuery) Clone() *BookQuery {
	...
	return &BookQuery{
		...
		withGenres: bq.withGenres.Clone(),
...
func (bq *BookQuery) WithGenres(opts ...func(*GenreQuery)) *BookQuery {
	query := &GenreQuery{config: bq.config}
...
func (bq *BookQuery) sqlAll(ctx context.Context) ([]*Book, error) {
	...
	if query := bq.withGenres; query != nil {
		...
		_spec := &sqlgraph.EdgeQuerySpec{
			...
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(book.GenresPrimaryKey[0], fks...))
			},
